...
def test_prompt_model_admin_form_validation(test_prompt_values) -> None:
    form_data = {
...
def test_prompt_model_admin_viewset_list_view(admin_client, setup_prompt_object) -> None:
...
def test_prompt_model_admin_viewset_edit_view(admin_client, setup_prompt_object) -> None:
...
def test_process_view_get_request(admin_client) -> None:
...
def test_process_view_post_without_text(admin_client) -> None:
    url = reverse("wagtail_ai:text_completion")
...
def test_process_view_with_bad_prompt_id(admin_client, prompt) -> None:
    url = reverse("wagtail_ai:text_completion")
...
def test_process_view_with_correct_prompt(admin_client, setup_prompt_object) -> None:
    url = reverse("wagtail_ai:text_completion")
