...
If an issue isn't being worked on by anyone, go for it! There's no need to ask "please assign me this issue". Add a comment to claim the issue once you're ready to start.
...
See the [project documentation](https://wagtail-ai.readthedocs.io/latest/contributing/) for instructions on developing, testing, linting, and building the project documentation.
