...
- Dropped support for Django 4.2; Django 5.2 is now the minimum supported version

## [3.1.1] - 2026-08-06

### Fixed

- Use the correct import path for Wagtail’s `get_image_model`
- Guess appropriate mime type when uploading an image. (Joshua Marantz)

## [3.1.0] - 2026-03-04

### Added

- Add support for custom `API_BASE` for the legacy `OpenAIBackend` still in use for rich text
